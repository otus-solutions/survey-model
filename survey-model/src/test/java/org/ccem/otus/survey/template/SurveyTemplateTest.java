...
//    String MockJsonSurveyFull = getJsonSurveyFull();
//
    survey = new Gson().fromJson(json, SurveyTemplate.class);
//    surveyWithGridCustomIds = new Gson().fromJson(jsonFull, SurveyTemplate.class);
...
//    assertEquals(expectedCustomIdGridTexts, surveyWithGridCustomIds.getGridTextCustomIds());
  ...
  public void getCustomIdsMethod_should(){
    System.out.println(surveyWithGridCustomIds.getCustomIds());
  }

//
//
//
//  public String getJsonSurveyFull(){
//    return "{" +
//      "\"extents\":\"StudioObject\"," +
//      "\"objectType\":\"Survey\"," +
//      "\"oid\":\"dXNlclVVSUQ6W3VuZGVmaW5lZF1zdXJ2ZXlVVUlEOlsxNjI5ZWI0MC03ZjNkLTExZWEtOWViYS05YjI0YjM3NzY3OTZdcmVwb3NpdG9yeVVVSUQ6WyBOb3QgZG9uZSB5ZXQgXQ==\"," +
...
//      "\"name\":\"OA-180 Validação de custom ID A\"," +
//      "\"acronym\":\"VCIDA\"," +
//      "\"recommendedTo\":\"\"," +
//      "\"description\":\"\"," +
//      "\"keywords\":[]" +
...
//      "\"creationDatetime\":\"2020-04-15T17:18:12.980Z\"," +
//      "\"otusStudioVersion\":\"\"" +
//      "}," +
//      "\"dataSources\":[]," +
//      "\"itemContainer\":[" +
...
//      "\"objectType\":\"Label\"," +
//      "\"oid\":\"\"," +
//      "\"plainText\":\"Validação de custom ID em  checkbox\"," +
//      "\"formattedText\":\"Validação de custom ID em&nbsp; checkbox\"}," +
//      "\"enUS\":{" +
//      "\"extends\":\"StudioObject\"," +
//      "\"objectType\":\"Label\"," +
//      "\"oid\":\"\"," +
...
//      "\"objectType\":\"FillingRules\"," +
//      "\"options\":{" +
//      "\"mandatory\":{\"extends\":\"StudioObject\"," +
//      "\"objectType\":\"Rule\"," +
//      "\"validatorType\":\"mandatory\"," +
//      "\"data\":{" +
//      "\"canBeIgnored\":false," +
...
//      "\"objectType\":\"Label\"," +
//      "\"oid\":\"\"," +
//      "\"plainText\":\"Validação de Custom ID em Grid de texto\"," +
//      "\"formattedText\":\"Validação de Custom ID em Grid de texto\"" +
//      "}," +
//      "\"enUS\":{" +
//      "\"extends\":\"StudioObject\"," +
//      "\"objectType\":\"Label\"," +
...
//      "\"objectType\":\"Label\"," +
//      "\"oid\":\"\"," +
//      "\"plainText\":\"Validação de Custom ID em Grid de Número Inteiro\"," +
//      "\"formattedText\":\"Validação de Custom ID em Grid de Número Inteiro\"}," +
//      "\"enUS\":{" +
//      "\"extends\":\"StudioObject\"," +
//      "\"objectType\":\"Label\"," +
//      "\"oid\":\"\"," +
